...
PlasmaCore.ColorScope {
    ...
    MouseArea {
        ...
        Clock {
            ...
            y: (parent.height - clock.height - units.gridUnit)
                ...
                Transition {
                    ...
                    ParallelAnimation {
                        PathAnimation {
                            ...
                            duration: 500
                            path: Path {
                                /* startX: clock.x; startY: clock.y+10 */
                                /* startX: 100; startY: 200 */
                                startX: clock.x; startY: (parent.height - clock.height - units.gridUnit)
                                PathLine {x: clock.x; y: (parent.height - clock.height - units.gridUnit + 10)}
                                /* endX: clock.x; endY: clock.y-10 */
                            }
                        }
                        NumberAnimation {
                            target: clock
