# Generated by Powerlevel10k configuration wizard on 2020-12-14 at 18:21 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%242F⎸'     # separate segments
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR=''          # separate segments nothing
  typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR='\uE0BC'        # separator between different-color segments on the left.
  typeset -g POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR='\uE0BA'       # separator between different-color segments on the right.
  ...
  typeset -g POWERLEVEL9K_DIR_ICON_BEFORE_CONTENT=true
  ...
  typeset -g POWERLEVEL9K_LOCK_ICON='%197F'
  ...
  # Icon to show when dir is non-existent
